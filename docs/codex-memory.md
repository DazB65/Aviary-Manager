...
- 2026-05-28: AI add-bird tool should resolve species from the species list by `speciesName`/`speciesId`, support small approved batches, and avoid requiring an existing bird of that species. Plain "yes"/"proceed" after an action confirmation should keep action tools available.
