...
export type EggOutcome = "unknown" | "fertile" | "infertile" | "cracked" | "hatched" | "died";
...
export const OUTCOME_OPTIONS: EggOutcome[] = ["unknown", "fertile", "infertile", "cracked", "hatched", "died"];
