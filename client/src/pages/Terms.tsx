  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 prose prose-gray">
        ...
        <p className="text-gray-600 leading-relaxed">
          Paid plans are billed in Australian dollars (AUD) via Stripe. Monthly and yearly subscriptions renew automatically until cancelled. A 7-day free trial is offered on new subscriptions — you will not be charged until the trial ends. Lifetime plans are a one-time payment with no recurring fees.
        </p>
