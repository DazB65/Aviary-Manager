  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 prose prose-gray">
        ...
        <p className="text-gray-600 leading-relaxed">
          Paid plans are billed in US dollars (USD) via Stripe. Monthly and yearly subscriptions renew automatically until cancelled. A 30-day trial is offered on all new accounts — no card required. After 30 days, a subscription is required to continue full access. Lifetime plans are a one-time payment with no recurring fees.
        </p>
